...
std::shared_ptr<Operand> Add::doOper(std::shared_ptr<Matrix> m1, std::shared_ptr<Matrix> m2) {
...
std::shared_ptr<Operand> Add::doOper(std::shared_ptr<Matrix>, std::shared_ptr<Float>) {
    return std::make_shared<Matrix>();
}
