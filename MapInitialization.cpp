...
void initializeOperationMap(OperationRegistry& registry) {
    ...
    registry.addOperator(":", FloatOperations::thernarfloat, OperationKey(":", std::vector<std::string>{"bool", "float", "float"}), 3, 2, Associativity::RightToLeft, Notation::Infix);
    ...
    registry.addOperationOverload("inverse", FloatOperations::floatInverse, OperationKey("inverse", std::vector<std::string>{"float"}));
    registry.addOperationOverload("+", FloatOperations::floatAddition, OperationKey("+", std::vector<std::string>{"float", "float"}));
    registry.addOperationOverload("-", FloatOperations::floatSubtraction, OperationKey("-", std::vector<std::string>{"float", "float"}));
    registry.addOperationOverload("/", FloatOperations::floatDivision, OperationKey("/", std::vector<std::string>{"float", "float"}));
    registry.addOperationOverload("*", FloatOperations::floatMultiplication, OperationKey("*", std::vector<std::string>{"float", "float"}));
    registry.addOperationOverload("==", FloatOperations::floatEqual, OperationKey("==", std::vector<std::string>{"float", "float"}));
    ...
    registry.addOperationOverload("*", MatrixOperations::floatMatrixMultiplication, OperationKey("*", std::vector<std::string>{"float", "matrix"}));
