...
std::shared_ptr<const const Operand> FloatOperations::floatAddition(const std::vector<std::shared_ptr<const Operand> >& arguments) {
...
std::shared_ptr<const Operand> FloatOperations::floatSubtraction(const std::vector<std::shared_ptr<const Operand> >& arguments) {
    auto f1 = std::static_pointer_cast<const Float>(arguments[0]);
    auto f2 = std::static_pointer_cast<const Float>(arguments[1]);
    return std::make_shared<Float>(f1->getValue() - f2->getValue());
}
std::shared_ptr<const Operand> FloatOperations::floatMultiplication(const std::vector<std::shared_ptr<const Operand> >& arguments) {
    auto f1 = std::static_pointer_cast<const Float>(arguments[0]);
    auto f2 = std::static_pointer_cast<const Float>(arguments[1]);
    return std::make_shared<Float>(f1->getValue() * f2->getValue());
}
std::shared_ptr<const Operand> FloatOperations::floatDivision(const std::vector<std::shared_ptr<const Operand> >& arguments) {
    auto f1 = std::static_pointer_cast<const Float>(arguments[0]);
    auto f2 = std::static_pointer_cast<const Float>(arguments[1]);
    return std::make_shared<Float>(f1->getValue() / f2->getValue());
}
...
std::shared_ptr<const Operand> FloatOperations::floatInverse(const std::vector<std::shared_ptr<const Operand> >& arguments) {
    auto flt = std::static_pointer_cast<const Float>(arguments[0]);
    return std::make_shared<Float>(-flt->getValue());
}
std::shared_ptr<const Operand> FloatOperations::floatEqual(const std::vector<std::shared_ptr<const Operand> >& arguments) {
...
std::shared_ptr<const Operand> FloatOperations::thernarfloat(const std::vector<std::shared_ptr<const Operand> >& arguments) {
